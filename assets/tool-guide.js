  ...
  function decorateHome() {
    ...
    if (notice && !document.querySelector('.yy-membership-strip')) {
      const content = config.mode === 'free'
        ? '<div class="yy-membership-strip"><div><b>11 款工具全部免费公测</b><p>无需登录，表格继续在浏览器本地处理。欢迎使用和反馈；未经许可请勿复制、转载或转售本站代码与工具。</p></div><a href="#tools">立即使用</a></div>'
